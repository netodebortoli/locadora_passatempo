...
public record Locacao(
        ...
        @NotNull(message = "O campo data de devolução prevista é obrigatório.") @Future(message = "O campo data de devolução prevista não pode ser anterior ou igual ao dia atual.") @Schema(type = "string", example = "2023-12-15", description = "Data de devolução prevista da locação.") Date dataDevolucaoPrevista,
